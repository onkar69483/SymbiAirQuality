...
DNSServer dnsServer; ESP8266WebServer server(80);
...
void setup() {
  ...
  server.onNotFound([]() { lastActivity=millis(); server.send(HTTP_CODE, "text/html", handleRoot()); });
...
html += "      <h1>Symbi Air Quality Station</h1>\n";
html += "    </div>\n";
